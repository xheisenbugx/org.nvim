...
describe("table emacs commands", function()
  ...
  it("eval_formula stores a column formula and recalculates", function()
  ...
  it("eval_formula with a count stores a field formula", function()
    ...
    eq({ "| 1 |  1 |", "| 2 | 99 |", "#+TBLFM: $2=$1::@2$2=99" }, buf_lines(buf))
  ...
  it("sum adds the current column below the header", function()
