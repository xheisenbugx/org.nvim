...
M.list = {
  ...
  meta_up = { "org.context", "meta_up", desc = "Move subtree / item / row / element up", modes = { "n", "x" } },
  meta_down = {
    "org.context",
    "meta_down",
    desc = "Move subtree / item / row / element down",
    modes = { "n", "x" },
  },
  ...
  down_element = { "org.element", "down", desc = "First child element" },
  mark_element = { "org.element", "mark", desc = "Select element", modes = { "n", "x" } },
  transpose_element = { "org.element", "transpose", desc = "Swap element with the previous one" },
  drag_element_up = { "org.element", "drag_backward", desc = "Drag element up" },
  drag_element_down = { "org.element", "drag_forward", desc = "Drag element down" },
  narrow_block = { "org.element", "narrow_to_block", desc = "Narrow to block (edit buffer)" },
  narrow_element = { "org.element", "narrow_to_element", desc = "Narrow to element (edit buffer)" },
  next_block = { "org.element", "next_block", desc = "Next block" },
  previous_block = { "org.element", "previous_block", desc = "Previous block" },
  toggle_fixed_width = { "org.element", "toggle_fixed_width", desc = "Toggle fixed-width (:)", modes = { "n", "x" } },
  list_make_subtree = { "org.lists", "make_subtree", desc = "Turn the list into a subtree" },
  toggle_radio_button = { "org.lists", "toggle_radio_button", desc = "Toggle radio button" },
  ...
  clock_report = { "org.clock", "clock_report", desc = "Insert / update clock report (count: first in buffer)" },
  clock_mark_default_task = { "org.clock", "mark_default_task", desc = "Mark entry as default clocking task" },
  clock_toggle_auto_clockout = {
    "org.clock",
  ...
  link_preview = {
    "org.ui.images",
    "link_preview",
    desc = "Toggle image previews (count: 4 hide, 16 buffer, 64 hide buffer)",
    modes = { "n", "x" },
  },
  link_preview_refresh = { "org.ui.images", "link_preview_refresh", desc = "Refresh image previews in the buffer" },
  latex_preview = {
    "org.ui.images",
    "latex_preview",
