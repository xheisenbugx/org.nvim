---@mod org.entities The org-entities table
---
--- Every entity of Emacs Org 9.8 (`org-entities`), generated from
--- org-entities.el: `{ name, latex, math, html, ascii, latin1, utf8 }`.
--- Used to display entities (pretty_entities) and to complete them.
...
M.list = {
  ...
  { "asymp", "\\asymp", true, "&asymp;", "[almost equal to]", "[almost equal to]", "≈" },
  { "approx", "\\approx", true, "&asymp;", "[almost equal to]", "[almost equal to]", "≈" },
  ...
  { "sube", "\\subseteq", true, "&sube;", "[subset of or equal to]", "[subset of or equal to]", "⊆" },
  { "nsup", "\\not\\supset", true, "&nsup;", "[not a superset of]", "[not a superset of]", "⊅" },
  { "supe", "\\supseteq", true, "&supe;", "[superset of or equal to]", "[superset of or equal to]", "⊇" },
  ...
  { "lceil", "\\lceil", true, "&lceil;", "[left ceiling]", "[left ceiling]", "⌈" },
  { "rceil", "\\rceil", true, "&rceil;", "[right ceiling]", "[right ceiling]", "⌉" },
  { "lfloor", "\\lfloor", true, "&lfloor;", "[left floor]", "[left floor]", "⌊" },
  { "rfloor", "\\rfloor", true, "&rfloor;", "[right floor]", "[right floor]", "⌋" },
  ...
  { "_   ", "\\hspace*{1.5em}", false, "&ensp;&ensp;&ensp;", "   ", "   ", "   " },
  { "_    ", "\\hspace*{2.0em}", false, "&ensp;&ensp;&ensp;&ensp;", "    ", "    ", "    " },
  { "_     ", "\\hspace*{2.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;", "     ", "     ", "     " },
  { "_      ", "\\hspace*{3.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "      ", "      ", "      " },
  { "_       ", "\\hspace*{3.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "       ", "       ", "       " },
  { "_        ", "\\hspace*{4.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "        ", "        ", "        " },
  { "_         ", "\\hspace*{4.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "         ", "         ", "         " },
  { "_          ", "\\hspace*{5.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "          ", "          ", "          " },
  { "_           ", "\\hspace*{5.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "           ", "           ", "           " },
  { "_            ", "\\hspace*{6.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "            ", "            ", "            " },
  { "_             ", "\\hspace*{6.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "             ", "             ", "             " },
  { "_              ", "\\hspace*{7.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "              ", "              ", "              " },
  { "_               ", "\\hspace*{7.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "               ", "               ", "               " },
  { "_                ", "\\hspace*{8.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "                ", "                ", "                " },
  { "_                 ", "\\hspace*{8.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "                 ", "                 ", "                 " },
  { "_                  ", "\\hspace*{9.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "                  ", "                  ", "                  " },
  { "_                   ", "\\hspace*{9.5em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "                   ", "                   ", "                   " },
  { "_                    ", "\\hspace*{10.0em}", false, "&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;", "                    ", "                    ", "                    " },
}
-- stylua: ignore end
...
function M.utf8(name)
  ...
  local x = ok and ast.ENTITIES and ast.ENTITIES[name]
  return x and x[2] or nil
end
