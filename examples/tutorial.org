...
give it a deadline. =2<prefix>s= removes the date again.
...
- =<C-c><C-c>= on a =CLOCK:= line recomputes its duration.
...
*Try:* change =:maxlevel 2= to =:maxlevel 3=, or add =:block thisweek= or
=:tags t=, and update it again.
